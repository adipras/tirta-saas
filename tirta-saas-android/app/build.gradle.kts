...
val mobileApiBaseUrl =
    providers.gradleProperty("MOBILE_API_BASE_URL").orElse("http://10.0.2.2:8081/api/").get()

android {
    namespace = "com.adipras.tirtasaas.mobile"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.adipras.tirtasaas.mobile"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "0.1.0"
